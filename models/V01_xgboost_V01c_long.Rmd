...
From 1b, I am adding 3 variables: roll_sd_ret11d_1Y	, above_sd_sma100, above_sd_sma200
...
df2 <- df |> 
  select(date, above_sd_ret1d_3M, above_sd_ret5d_3M, above_sd_ret5d_7M, 
         roll_sd_ret11d_1Y, 
         above_sd_intraday_1Y, roll_sd_intra_day_3M, 
         above_sd_sma100, above_sd_sma200, 
...
write_csv(yo_metric, paste0(the_path, "/models/model_metrics/xgboost_modelv1c_", model_type, "_", ticker, ".csv"))
...
write_rds(model_base, paste0(the_path, "/models/model_raw/xgboost_modelv1c_", model_type, "_", ticker, ".rda"))
...
write_csv(var_importance, paste0(the_path, "/models/model_vars_imp/xgboost_modelv1c_", model_type, "_", ticker, ".csv"))
rm(df_prep)
```
...
source(glue(the_path, "/models/functions/model_v1c.R"))
...
var_amd <- read_csv(glue(the_path, '/models/model_vars_imp/xgboost_modelv1c_thirdile_', 'AMD', '.csv'), 
