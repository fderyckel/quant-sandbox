---
title: "Xgboost Modeling Long 41 days. Regression with percentile returns. V3a"
format: 
  html: 
    toc: true
    toc-depth: 2
...
Check correlation
check correlation: 
Use some pca or umap
Use returns from stock in my universe (add IYT), add HYG
Use how many percent is the stock above main MA
use how many percent is the stock above long term MA trend (3 years, medium term 1 year and short term 5 or 7 months)
