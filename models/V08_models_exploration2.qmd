...
mean_roll_200 <- slidify(.f = mean, .align = 'right', .period = 252)
sd_roll_200 <- slidify(.f = sd, .align = 'right', .period = 252)
...
augment_df_fin <- function(df){
  df <- df |>   
    ...
    mutate(ret21d = log(adjusted / lag(adjusted, n = 21)), 
           ...
           roll_sd_ema23_200d = mean_roll_200(perc_abov_ema23),
           sd_abov_ema23 = (ema23 - roll_mean_ema23_200d) / roll_sd_ema23_200d, 
           
           roll_mean_sma47_200d = mean_roll_200(perc_abov_sma47), 
           roll_sd_sma47_200d = mean_roll_200(perc_abov_sma47),
           sd_abov_sma47 = (sma47 - roll_mean_sma47_200d) / roll_sd_sma47_200d, 
           
           roll_mean_sma101_1Y = mean_roll_252(perc_abov_sma101), 
           roll_sd_sma101_1Y = mean_roll_252(perc_abov_sma101),
           ...
           rll_sd_volum200_1Y = sd_roll_252(volum200_perc), 
...
reduce_df <- function(df) { 
  df <- df |> 
    select(date, 
           ...
           roll_sd_ret21d_1Y, rll_sd_volum200_1Y, 
           ret_7w)
}
...
write_rds(model_base, 
          paste0(the_path, "/models/model_raw/xgboost_modelv8_explo2_", model_type, "_", ticker, ".rda"))
...
write_csv(var_importance, 
          paste0(the_path, "/models/model_vars_imp/xgboost_modelv8_explo2_", model_type, "_", ticker, ".csv"))
rm(df_prep)
...
source(glue(the_path, "/models/functions/model_v8_2.R"))

model <- 'version_v8_2'
tickers = c('AMD', 'AAPL', 'FDX', 'GOOG', 'HAL', 'PYPL', 'CVX', 'SBUX') 
...
write_csv(df1, 'correlations/model_v8_2.csv')
