...
augment_df_fin <- function(df){
  df <- df |>   
    ...
    mutate(roc21 = log(adjusted / lag(adjusted, n = 21)), 
           ...
           roll_sd_ret21d_1Y = sd_roll_252(roc21), 
...
reduce_df <- function(df) { 
  df <- df |> 
    select(date, 
           ...
           roll_sd_ret21d_1Y, volat_volu200_252d, 
           ret_7w)
}
...
write_csv(yo_metric, 
          paste0(the_path, "/models/model_metrics/xgboost_modelv8_explo2_", model_type, "_", ticker, ".csv"))
