...
augment_df_fin <- function(df){
  df <- df |>   
    ...
    mutate(ret21d = log(adjusted / lag(adjusted, n = 21)), 
           ...
           corr_ema23_sma101_1Y = corr_roll_252(ema23, sma101), 
           corr_ema23_sma47_1Y = corr_roll_252(ema23, sma47), 
           corr_sma50_sma200_1Y = corr_roll_252(sma50, sma200), 
...
reduce_df <- function(df) { 
  df <- df |> 
    select(date, 
           ...
           corr_ema23_sma101_1Y, corr_ema23_sma47_1Y, corr_sma50_sma200_1Y,  
