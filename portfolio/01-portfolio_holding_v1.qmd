...
# My positions 
tickers = c('EWZ','GDXJ','RGLD', 'RIO', 'CLF', 'COP', 'PSX', 'XOM', 'SMH', 'IBM','DASH','META', 'GOOG') 
etf1 =    c('UUP', 'UUP', 'UUP', 'SPY', 'SPY', 'SPY', 'SPY', 'SPY', 'QQQ', 'QQQ', 'QQQ', 'SPY', 'SPY')
etf2 =    c('EEM', 'GLD', 'GDX', 'XME', 'XME', 'XLE', 'XLE', 'XLE', 'XLK', 'XLK', 'XLK', 'XLC', 'XLC')
