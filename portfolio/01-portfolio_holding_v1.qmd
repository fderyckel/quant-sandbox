...
# My positions 
tickers = c('EWH', 'EWZ', 'EEM', 'EWJ', 'GDXJ', 'FCX', 'RIO', 'CLF', 'MOS', 
            'OXY', 'HAL', 'CAT', 'MTCH', 
            'CHTR', 'CAT', 'GS', 'AON', 'CBOE', 'C', 'AMZN', 'NVDA', 'DASH', 
            'NEE',  'EL', 'YUM', 'ABBV', 'RVTY') 
etf1 =    c('EEM', 'EEM', 'UUP', 'UUP', 'UUP', 'SPY', 'SPY', 'SPY',  'SPY', 
            'SPY', 'SPY', 'SPY', 'SPY', 
            'SPY', 'SPY', 'SPY', 'SPY', 'SPY', 'SPY', 'SPY', 'SPY', 'SPY', 
            'SPY', 'SPY', 'SPY', 'SPY', 'SPY')
etf2 =    c('EEM', 'EEM', 'UUP', 'UUP', 'UUP', 'XME', 'XME', 'XME', 'XME', 
            'XLE', 'SPY', 'XLI', 'XLC', 
            'XLC', 'XLI', 'XLF', 'XLF', 'XLF', 'XLF', 'XLY', 'XLK', 'XLK',
            'XLU', 'XLP', 'XLY', 'XLV', 'XLV')
