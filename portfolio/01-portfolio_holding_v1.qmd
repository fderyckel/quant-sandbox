...
# My positions 
tickers = c('EWZ','GDXJ','RGLD', 'RIO', 'CLF', 'COP', 'HAL', 'AON','AMZN', 'SMH','META', 'YUM') 
etf1 =    c('UUP', 'UUP', 'UUP', 'SPY', 'SPY', 'SPY', 'SPY', 'SPY', 'SPY', 'QQQ', 'SPY', 'SPY')
etf2 =    c('EEM', 'GLD', 'GDX', 'XME', 'XME', 'XLE', 'XLE', 'XLF', 'XLY', 'XLK', 'XLC', 'XLY')
