...
# My positions 
tickers = c('EWH', 'EWZ', 'EEM', 'EWJ', 'GDXJ', 'GROY', 'FCX', 'OXY', 'CGC', 'CHTR', 
            'CBOE', 'C', 'NEE',  'EL', 'YUM', 'ABBV', 'RVTY') 
etf1 =    c('EEM', 'EEM', 'UUP', 'UUP', 'UUP',  'UUP', 'SPY',  'SPY', 'SPY', 'SPY', 
            'SPY', 'SPY', 'SPY', 'SPY', 'SPY', 'SPY', 'SPY')
etf2 =    c('EEM', 'EEM', 'UUP', 'UUP', 'UUP',  'XME', 'XME', 'XLE', 'XLV',  'XLC', 
            'XLF', 'XLF', 'XLU', 'XLP', 'XLY', 'XLV', 'XLV')

stock_tickers <- unique(c(tickers, etf1, etf2))
