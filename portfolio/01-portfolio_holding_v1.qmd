...
df <- tibble(ticker = sectors, etf1 = 'SPY', etf2 = 'QQQ')
...
# My positions 
tickers = c('EWH', 'EWZ', 'EEM', 'EWJ', 'GDXJ', 'GROY', 'FCX', 'OXY', 'HAL', 
            'CGC', 'CHTR', 
            'CBOE', 'C', 'NEE',  'EL', 'YUM', 'ABBV', 'RVTY') 
etf1 =    c('EEM', 'EEM', 'UUP', 'UUP', 'UUP',  'UUP', 'SPY',  'SPY', 'SPY', 
            'SPY', 'SPY', 
            'SPY', 'SPY', 'SPY', 'SPY', 'SPY', 'SPY', 'SPY')
etf2 =    c('EEM', 'EEM', 'UUP', 'UUP', 'UUP',  'XME', 'XME', 'XLE', 'SPY', 
            'XLV', 'XLC', 
            'XLF', 'XLF', 'XLU', 'XLP', 'XLY', 'XLV', 'XLV')

stock_tickers <- unique(c(tickers, 'UUP', 'EEM')) 
