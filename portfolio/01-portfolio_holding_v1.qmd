...
# My positions 
df <- tibble(ticker = c('CBOE', 'NEE', 'OXY', 'EWZ', 'EWJ', 'EEM', 'EWH', 'GDXJ', 'CGC', 'GROY', 'LUC.TO', 'TSLA'))

tickers = c('EWH', 'EWZ', 'EEM', 'EWJ', 'GDXJ', 'GROY', 'OXY', 'CGC', 'CBOE', 
            'C', 'NEE', 'TSLA', 'ABBV', 'RVTY') 
etf1 =    c('EEM', 'EEM', 'UUP', 'UUP', 'UUP', 'UUP',  'SPY', 'SPY',  'SPY', 
            'SPY', 'SPY', 'SPY', 'SPY', 'SPY')

stock_tickers <- c(tickers, 'UUP', 'EEM')
